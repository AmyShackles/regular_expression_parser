    ...
    getLooks: (string) => {
        ...
        getParenStack(string).forEach(({group, startingIndex, endingIndex}) => {
            ...
            if (positive_lookbehind || positive_lookahead || negative_lookbehind || negative_lookahead) {
                looks[startingIndex] = {
                    ...(positive_lookahead ? { positive_lookahead: { group: positive_lookahead['groups']['positive_lookahead'], startingIndex, endingIndex }} : ''),
                    ...(positive_lookbehind ? { positive_lookbehind: { group: positive_lookbehind['groups']['positive_lookbehind'], startingIndex, endingIndex }} : ''),
                    ...(negative_lookbehind ? { negative_lookbehind: { group: negative_lookbehind['groups']['negative_lookbehind'], startingIndex, endingIndex }} : ''),
                    ...(negative_lookahead ? { negative_lookahead: { group: negative_lookahead['groups']['negative_lookahead'], startingIndex, endingIndex }} : '')
                }
            }
