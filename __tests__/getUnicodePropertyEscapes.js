...
describe("getUnicodePropertyEscapes", () => {
    ...
    it("adds unicode property escapes", () => {
        ...
        expect(unicodePropertyEscapes).toHaveProperty(`${unicodePropertyEscapeIndexes[0]}.unicode_property_escape.endingIndex`, 9);
        ...
        expect(unicodePropertyEscapes).toHaveProperty(`${unicodePropertyEscapeIndexes[1]}.unicode_property_escape.endingIndex`, 36);
    ...
    it("adds negated unicode property escapes", () => {
        ...
        expect(unicodePropertyEscapes).toHaveProperty(`${negatedUnicodePropertyEscapeIndexes[0]}.negated_unicode_property_escape.endingIndex`, 55);
        ...
        expect(unicodePropertyEscapes).toHaveProperty(`${negatedUnicodePropertyEscapeIndexes[1]}.negated_unicode_property_escape.endingIndex`, 62);
