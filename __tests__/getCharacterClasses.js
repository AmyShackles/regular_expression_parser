    ...
    const characterClasses = getCharacterClasses(expression, flags);
        ...
        it("should add digits", () => {
            digitIndexes.forEach(digit => {
                ...
                expect(characterClasses).toHaveProperty(`${digit}.digit.lastIndex`);
            ...
            expect(characterClasses).toHaveProperty(`${digitIndexes[0]}.digit.lastIndex`, 29);
        ...
        it("should add non-digits", () => {
            nonDigitIndexes.forEach(nonDigit => {
                ...
                expect(characterClasses).toHaveProperty(`${nonDigit}.non_digit.lastIndex`);
            ...
            expect(characterClasses).toHaveProperty(`${nonDigitIndexes[0]}.non_digit.lastIndex`, 9);
        ...
        it("should add alphanumerics", () => {
            alphanumericIndexes.forEach(alpha => {
                ...
                expect(characterClasses).toHaveProperty(`${alpha}.alphanumeric.lastIndex`);
            ...
            expect(characterClasses).toHaveProperty(`${alphanumericIndexes[0]}.alphanumeric.lastIndex`, 13);
        ...
        it("should add non-alphanumerics", () => {
            nonAlphanumericIndexes.forEach(nonAlpha => {
                ...
                expect(characterClasses).toHaveProperty(`${nonAlpha}.non_alphanumeric.lastIndex`);
            ...
            expect(characterClasses).toHaveProperty(`${nonAlphanumericIndexes[0]}.non_alphanumeric.lastIndex`, 5);
        ...
        it("should add whitespaces", () => {
            whitespaceIndexes.forEach(whitespace => {
                ...
                expect(characterClasses).toHaveProperty(`${whitespace}.whitespace.lastIndex`);
            ...
            expect(characterClasses).toHaveProperty(`${whitespaceIndexes[0]}.whitespace.lastIndex`, 35);
        ...
        it("should add non-whitespaces", () => {
            nonWhitespaceIndexes.forEach(nonWhitespace => {
                ...
                expect(characterClasses).toHaveProperty(`${nonWhitespace}.non_whitespace.lastIndex`);
            ...
            expect(characterClasses).toHaveProperty(`${nonWhitespaceIndexes[0]}.non_whitespace.lastIndex`, 3);
        ...
        it("should add horizontal tabs", () => {
            horizontalTabIndexes.forEach(horizontalTab => {
                ...
                expect(characterClasses).toHaveProperty(`${horizontalTab}.horizontal_tab.lastIndex`);
            ...
            expect(characterClasses).toHaveProperty(`${horizontalTabIndexes[0]}.horizontal_tab.lastIndex`, 46);
        ...
        it("should add carriage returns", () => {
            carriageReturnIndexes.forEach(carriageReturn => {
                ...
                expect(characterClasses).toHaveProperty(`${carriageReturn}.carriage_return.lastIndex`);
            ...
            expect(characterClasses).toHaveProperty(`${carriageReturnIndexes[0]}.carriage_return.lastIndex`, 44);
        ...
        it("should add linefeeds", () => {
            lineFeedIndexes.forEach(lineFeed => {
                ...
                expect(characterClasses).toHaveProperty(`${lineFeed}.linefeed.lastIndex`);
            ...
            expect(characterClasses).toHaveProperty(`${lineFeedIndexes[0]}.linefeed.lastIndex`, 16);
        ...
        it("should add vertical tabs", () => {
            verticalTabIndexes.forEach(verticalTab => {
                ...
                expect(characterClasses).toHaveProperty(`${verticalTab}.vertical_tab.lastIndex`);
            ...
            expect(characterClasses).toHaveProperty(`${verticalTabIndexes[0]}.vertical_tab.lastIndex`, 18);
        ...
        it("should add form feeds", () => {
            formFeedIndexes.forEach((formFeed) => {
                ...
                expect(characterClasses).toHaveProperty(`${formFeed}.form_feed.lastIndex`);
            ...
            expect(characterClasses).toHaveProperty(`${formFeedIndexes[0]}.form_feed.lastIndex`, 109);
        ...
        it("should add backspaces", () => {
            backspaceIndexes.forEach((backspace) => {
                ...
                expect(characterClasses).toHaveProperty(`${backspace}.backspace.lastIndex`);
            ...
            expect(characterClasses).toHaveProperty(`${backspaceIndexes[0]}.backspace.lastIndex`, 106);
        ...
        it("should add NUL", () => {
            nulIndexes.forEach((nul) => {
                ...
                expect(characterClasses).toHaveProperty(`${nul}.NUL.lastIndex`);
            ...
            expect(characterClasses).toHaveProperty(`${nulIndexes[0]}.NUL.lastIndex`, 103);
        ...
        it("should add control characters", () => {
            controlCharacterIndexes.forEach((controlCharacter) => {
                ...
                expect(characterClasses).toHaveProperty(`${controlCharacter}.control_character.lastIndex`);
            ...
            expect(characterClasses).toHaveProperty(`${controlCharacterIndexes[0]}.control_character.lastIndex`, 101);
        ...
        it("should add hexadecimals", () => {
            hexIndexes.forEach((hex) => {
                ...
                expect(characterClasses).toHaveProperty(`${hex}.hex.lastIndex`);
            ...
            expect(characterClasses).toHaveProperty(`${hexIndexes[0]}.hex.lastIndex`, 114);
        ...
        it("should add dots and not dotAlls if dotAll flag is not set", () => {
            ...
            dotIndexes.forEach((dot) => {
                ...
                expect(characterClasses).toHaveProperty(`${dot}.dot.lastIndex`);
            ...
            expect(characterClasses).toHaveProperty(`${dotIndexes[0]}.dot.lastIndex`, 110);
        ...
        it("should add dotAlls and not dots if dotAll flag is set ", () => {
            ...
            dotAllIndexes.forEach((dotAll) => {
                ...
                expect(characterClasses).toHaveProperty(`${dotAll}.dotAll.lastIndex`);
            ...
            expect(characterClasses).toHaveProperty(`${dotAllIndexes[0]}.dotAll.lastIndex`, 110);
